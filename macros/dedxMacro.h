...
// Wed Jul 18 15:46:46 2018 by ROOT version 6.12/04
// from TTree anatree/analysis tree
// found on file: ../files/data_anaTree.root
//////////////////////////////////////////////////////////
...
#ifdef dedxMacro_cxx
dedxMacro::dedxMacro(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../files/data_anaTree.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../files/data_anaTree.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("../files/data_anaTree.root:/anatree");
...
Int_t dedxMacro::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t dedxMacro::LoadTree(Long64_t entry)
{
...
void dedxMacro::Init(TTree *tree)
{
...
void dedxMacro::Show(Long64_t entry)
{
...
Int_t dedxMacro::Cut(Long64_t entry)
{
