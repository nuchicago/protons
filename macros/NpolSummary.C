#define NpolSummary_cxx
#include "NpolSummary.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>

void NpolSummary::Loop()
{
//   In a ROOT session, you can do:
//      root> .L NpolSummary.C
//      root> NpolSummary t
...
//by  b_branchname->GetEntry(ientry); //read only this branch
  ...
  //Opening primaryID file
   ...
   std::ifstream idfile("../files/PrimaryID_NP.txt");
   Long64_t fileEntry;
   ...
   while(idfile >> fileEntry >> reco_primary >> isInelastic >> Int_x >> Int_y >> Int_z 
    >> Int_type >> selCrit>> InitialKE >> IntKE >> truthIntKE >> beamMass){
   ...
   Long64_t jentry = fileEntry;
      ...
      if (primary_pts > 0){
        ...
        */
        ...
        sprintf(eventdisp_title,"../plotting/images/EventSummary/Negative_Pol/EventSummary%d.png",event);
