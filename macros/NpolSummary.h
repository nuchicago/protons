...
// Mon Aug 20 16:27:26 2018 by ROOT version 6.12/04
// from TTree anatree/analysis tree
// found on file: ../files/negative_polarity_preproduction_test_reco_ntuple_20180817_1411.root
//////////////////////////////////////////////////////////

#ifndef NpolSummary_h
#define NpolSummary_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Double_t        track_spt_idarr[96][1000][100];   //[ntracks_reco]
   Double_t        track_spt_earr[96][1000][100];   //[ntracks_reco]
...
#ifdef NpolSummary_cxx
NpolSummary::NpolSummary(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../files/negative_polarity_preproduction_test_reco_ntuple_20180817_1411.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../files/negative_polarity_preproduction_test_reco_ntuple_20180817_1411.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("../files/negative_polarity_preproduction_test_reco_ntuple_20180817_1411.root:/anatree");
...
NpolSummary::~NpolSummary()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t NpolSummary::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t NpolSummary::LoadTree(Long64_t entry)
{
...
void NpolSummary::Init(TTree *tree)
{
...
void NpolSummary::Show(Long64_t entry)
{
...
Int_t NpolSummary::Cut(Long64_t entry)
{
...
double NpolSummary::pointDistance(double x1, double y1, double z1, double x2, double y2, double z2){

    double dist = sqrt( pow(x2-x1,2) + pow(y2-y1,2) + pow(z2-z1,2));
    return dist;}
#endif // #ifdef NpolSummary_cxx
